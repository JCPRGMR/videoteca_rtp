    ...
    <header class="p10 f-row jc-b wrap gap10">
        <div class="f-row gap20 a-c">
            ...
            <div class="f-row gap10">
                ...
                <!--a href="../Views/Programming.php" class="txtwhite negrita mayus txthover1 p5 <?php // ($_SERVER['REQUEST_URI'] == '/Views/Programming.php' || $_SERVER['REQUEST_URI'] == '/Views/ProgrammingForm.php')? 'text1 b1-bot' : ''; ?>">programacion</a -->
            </div>
        </div>
