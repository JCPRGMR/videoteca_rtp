...
search.addEventListener('input', function() {
    if (isRequestInProgress) return; // Si hay una solicitud en progreso, salir de la función

    isRequestInProgress = true; // Marcar que una solicitud está en progreso
